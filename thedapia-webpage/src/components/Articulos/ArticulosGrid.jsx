    ...
    <div>
      <div className="grid grid-cols-4 gap-12">
        {currentArticulos.map((articulo, index) => (
          <div key={index} className="border-x-2 border-t-2rounded-x-2xl rounded-t-2xl w-80 bg-white ">
            <img className = "w-full h-72 object-contain border-2 border-b-black " src={articulo.img} alt="imagen-articulo" />
            <div className='text-center p-4 h-36'>
                <h3 className='text-2xl'>{articulo.title}</h3>
                <p className='text-xl'>$19990</p>
            </div>
