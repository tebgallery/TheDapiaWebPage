...
const Order = () => {
  ...
  return (
    <div>
      <div className="w-full h-48 mb-12 flex justify-center bg-emerald-500 hover:opacity-60 hover:cursor-pointer">
      ...
      <div className="grid grid-cols-12 gap-2">
        <div className="col-span-8 m-auto flex items-center justify-center">
          <div className="w-9/12 mr-2 p-2">
            ...
            <div className="flex justify-end">
              <button className="bg-black text-white uppercase px-2 py-1 w-1/3 h-12 my-10 hover:opacity-65">
        ...
        <div className="col-span-4">
            <div className="sticky top-12 w-10/12 border-t border-gray-500">
          {parsedCart.map((producto, _id) => (
            <div
              key={_id}
              className="w-2/3 border-b border-gray-400 ml-10 p-2  "
            >
              <div>
                <img
                  src={producto.imagen}
